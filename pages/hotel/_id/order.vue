    ...
    <section class="container is-widescreen">
      <div class="columns order">
        ...
        <div class="column is-4-desktop order-pay is-hidden-touch">
          <order-pay :roomTypeNum="roomTypeNum"
                     :resData="resData"
                     :resPrice="resPrice"
          ...
          <div class="modal-main">
            ...
            <ul class="main-items">
              ...
              <li>
                <p>手机号</p>
                <div class="item-input">
                  <input type="tel" :value="'+'+realInfoPop.telephoneCountryPrefix" disabled class="prefix">
          ...
          <div class="modal-main">
            ...
            <ul class="main-items">
              ...
              <li>
                <p>手机号</p>
                <div class="item-input">
                  <input type="tel" :value="'+'+realInfoPopDetail.telephoneCountryPrefix" disabled class="prefix">
          ...
          <div class="modal-main">
            ...
            <ul class="main-items">
              ...
              <li>
                <p>手机号（选填）</p>
                <div class="item-input">
                  <input type="tel" v-model="'+'+addInfoPop.telephoneCountryPrefix" class="prefix" disabled>
          ...
          <div class="modal-main">
            ...
            <ul class="main-items">
              ...
              <li>
                <p>手机号（选填）</p>
                <div class="item-input">
                  <input type="tel" v-model="'+'+editInfoPop.telephoneCountryPrefix" class="prefix" disabled>
...
<script>
  ...
  export default {
    ...
    asyncData (context) {
      ...
      let [id, roomTypeId, roomTypeIndex, roomTypeNum, _selfArrivalDate, _selfDepartureDate, _selfServiceStr, pt, currency, currencyCode, currencySymbol] =
        [context.params.id, context.query.roomTypeId, `${context.query.roomTypeIndex}`, `${context.query.roomTypeNum}`, context.query.arrivalDate,
      ...
      if(_selfArrivalDate && _selfDepartureDate){
         ...
         * 房源详情 / 房源价格 / 国家列表
         * */
        let reqBodyPrice = {arrivalDate: _selfArrivalDate, departureDate:_selfDepartureDate, roomNum: roomTypeNum};
        if(_selfServiceStr){
          reqBodyPrice.s = _selfServiceStr;
        }
        return axios.all([hotel.get({pt: pt, currency: currencyCode}, id),
          hotel.price({pt: pt, currency: currencyCode}, id, roomTypeId, reqBodyPrice),
    ...
    methods: {
      ...
      subService() {
        ...
        this.$router.push({query:{
          roomTypeId: this.resData.roomTypes[this.roomTypeIndex].id, roomTypeIndex:this.roomTypeIndex, roomTypeNum:this.roomTypeNum,
            arrivalDate:this.arrivalDate, departureDate:this.departureDate, currency: this.$route.query.currency, s: serviceArr.join()}});
        // this.isService = false
      },
      ...
      async toggleInsurance(){
        ...
        try{
          let { data } = await this.$api.hotel.price({pt: this.deviceType.type, currency: this.currencyCode}, this.$route.params.id, this.$route.query.roomTypeId, reqBody);
          if(data.code == 0){
          ...
          if(this.resOrderInfo.payExpiredSeconds > 0){
            ...
            try{
              ...
              reqBody = {
                ...
                arrivalDate: this.arrivalDate,
                departureDate: this.departureDate,
                roomTypeId: this.resData.roomTypes[this.roomTypeIndex].id,
              ...
              this.$nuxt.$loading.start();
              let { data : order } = await this.$api.hotel.order({pt: this.deviceType.type, currency: this.currencyCode}, this.authUser, reqBody);
              this.$nuxt.$loading.finish();
              if(order.code == 0){
